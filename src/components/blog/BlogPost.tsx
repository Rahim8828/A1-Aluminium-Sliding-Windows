    ...
    <article className="max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-8 pb-8 border-b border-gray-200">
        ...
        <button
          ...
          className="p-2 rounded-full bg-orange-700 text-white hover:bg-orange-800 transition-colors"
