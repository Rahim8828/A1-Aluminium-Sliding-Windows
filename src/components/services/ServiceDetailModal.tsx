            ...
            <section>
              ...
              <div className="mt-4 p-4 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl border-2 border-orange-200">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h4 className="font-bold text-sm text-gray-900 mb-1">Need Something Custom?</h4>
                    <p className="text-xs text-gray-600 mb-3">Get a personalized solution tailored to your specific requirements</p>
                    <a
                      href={`https://wa.me/919082877332?text=${encodeURIComponent(`Hi! I need a customized ${service.title} service. Can you help?`)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-all active:scale-95"
                    >
              ...
              <div className="mt-3 p-3 bg-amber-50 rounded-lg border border-amber-200 flex items-center gap-2">
                ...
                <p className="text-xs text-amber-800">
                  <span className="font-bold">Visiting Charge:</span> ₹149 (One-time, refundable on service booking)
                </p>
              </div>
