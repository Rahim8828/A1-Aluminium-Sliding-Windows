...
export function StatsCounter() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-16 md:py-20 bg-gradient-to-r from-orange-600 to-orange-800 relative overflow-hidden"
    >
      {/* Background Pattern */}
...
function StatItem({ stat, isVisible, delay }: StatItemProps) {
  ...
  return (
    <div className="text-center group">
      ...
      {/* Label */}
      <div className="text-sm md:text-base lg:text-lg text-orange-100 font-medium">
        {stat.label}
      </div>
    </div>
  );
